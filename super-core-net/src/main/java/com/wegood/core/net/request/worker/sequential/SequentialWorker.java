package com.wegood.core.net.request.worker.sequential;

import com.wegood.core.net.request.Request;
import com.wegood.core.net.request.handler.RequestHandler;
import com.wegood.core.net.request.worker.Worker;
