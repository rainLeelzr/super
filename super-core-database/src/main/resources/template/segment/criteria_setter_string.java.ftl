<#if field.propertyType == "String">
    ...
    public ${entity}Criteria setOr${field.capitalName}Like(${field.propertyType} or${field.propertyName?cap_first}Like) {
    ...
    public ${entity}Criteria setOr${field.capitalName}NotLike(${field.propertyType} or${field.propertyName?cap_first}NotLike) {
    ...
    public ${entity}Criteria set${field.capitalName}StartWith(${field.propertyType} ${field.propertyName}StartWith) {
    ...
    public ${entity}Criteria setOr${field.capitalName}StartWith(${field.propertyType} or${field.propertyName?cap_first}StartWith) {
