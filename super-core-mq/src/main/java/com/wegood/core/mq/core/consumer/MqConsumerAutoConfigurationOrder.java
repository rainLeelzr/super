...
import com.wegood.core.mq.MqAutoConfiguration;
import com.wegood.core.support.ExceptionCatcher;
 ...
 */
@Component
public class MqConsumerAutoConfigurationOrder implements ApplicationContextAware, SmartLifecycle {
