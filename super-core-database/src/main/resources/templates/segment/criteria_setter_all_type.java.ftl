    ...
    public ${entity}Criteria setOr${field.capitalName}(${field.propertyType} ${field.propertyName}) {
    ...
    public ${entity}Criteria setOr${field.capitalName}NotEqual(${field.propertyType} or${field.propertyName?cap_first}NotEqual) {
    ...
    public ${entity}Criteria set${field.capitalName}In(Collection<${field.propertyType}> ${field.propertyName}s) {
        this.${field.propertyName}In = ${field.propertyName}s;
        in(${entity}.${field.name?upper_case}, this.${field.propertyName}In);
        return this;
    }

    public ${entity}Criteria setOr${field.capitalName}In(Collection<${field.propertyType}> ${field.propertyName}s) {
    ...
    public ${entity}Criteria set${field.capitalName}NotIn(Collection<${field.propertyType}> ${field.propertyName}s) {
        this.${field.propertyName}NotIn = ${field.propertyName}s;
        notIn(${entity}.${field.name?upper_case}, this.${field.propertyName}NotIn);
        return this;
    }

    public ${entity}Criteria setOr${field.capitalName}NotIn(Collection<${field.propertyType}> ${field.propertyName}s) {
    ...
    @JsonIgnore
    public ${entity}Criteria set${field.capitalName}In(${field.propertyType}... ${field.propertyName}s) {
    ...
    @JsonIgnore
    public ${entity}Criteria setOr${field.capitalName}In(${field.propertyType}... ${field.propertyName}s) {
    ...
    @JsonIgnore
    public ${entity}Criteria set${field.capitalName}NotIn(${field.propertyType}... ${field.propertyName}s) {
    ...
    @JsonIgnore
    public ${entity}Criteria setOr${field.capitalName}NotIn(${field.propertyType}... ${field.propertyName}s) {
