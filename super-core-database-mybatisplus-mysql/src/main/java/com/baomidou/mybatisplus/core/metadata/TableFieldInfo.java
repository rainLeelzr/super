...
import vip.isass.core.database.mybatisplus.typehandler.GeometryTypeHandler;

import java.lang.reflect.Field;

/**
 * 支持 mysql 空间字段查询，select 空间字段添加 AsText 函数包裹
 *
...
public class TableFieldInfo implements Constants {
    ...
    public TableFieldInfo(GlobalConfig.DbConfig dbConfig, TableInfo tableInfo, Field field, TableField tableField) {
        ...
        if (tableField.typeHandler() == GeometryTypeHandler.class) {
            this.sqlSelect = "AsText(" + column + ") as " + column;
        }
