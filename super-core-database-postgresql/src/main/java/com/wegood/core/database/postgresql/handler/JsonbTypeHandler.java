package com.wegood.core.database.postgresql.handler;

import com.wegood.core.database.postgresql.entity.JsonPg;
import com.wegood.core.entity.Json;
import com.wegood.core.support.json.DefaultJson;
